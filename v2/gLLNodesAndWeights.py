...
# Source: https://colab.research.google.com/github/caiociardelli/sphglltools/blob/main/doc/L3_Gauss_Lobatto_Legendre_quadrature.ipynb
...
print("POLY DEGREE: %i" % poly_degree)
print(" gLL Nodes:")
for i in range(0,n):
    print("%1.16e" % xi[i])
print("\n Equidistant Nodes:")
equidistant = np.linspace(-1.0,1.0,n,dtype=np.float128)
equidistant_step_size = 2.0/np.float128(poly_degree)
val = -1.0
for i in range(0,n):
    # print("%1.16e" % equidistant[i])
    print("%1.16e" % val)
    val += equidistant_step_size